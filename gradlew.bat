...
<!-- blaze-out/k8-opt/genfiles/java/com/google/android/gmscore/integ/client/base/res/values-en-rGB/strings.xml -->
<eat-comment/>
...
<string name="common_google_play_services_notification_channel_name" msgid="4293541511340436975">"Google Play services availability"</string>
...
<string name="common_google_play_services_wear_update_text" msg